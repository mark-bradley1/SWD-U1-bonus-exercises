...
// let bostonCreme = new Donut("yeast", "sphere", false);
// bostonCreme.filling = "custard filled";
// bostonCreme.icing = "chocolate";
// console.log(bostonCreme);
...
// let myHouse = new HouseForSale("single-family", 1956, 260000, 1300, 4, 2, true, true);
// console.log(myHouse);
...
class Instrument {
	...
	describe() {
		console.log(`${this.name} is part of the ${this.category} family of instruments and sounds like ${this.soundsLike}`);
	}
}
